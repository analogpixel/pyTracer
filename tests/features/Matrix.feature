Feature: Matrix
  ...
  Scenario: Calculating the inverse of another matrix
    Given the following 4x4 matrix V:
      |  8 | -5 |  9 |  2 |
      |  7 |  5 |  6 |  1 |
      | -6 |  0 |  9 |  6 |
      | -3 |  0 | -9 | -4 |
    Then inverse(V) is the following 4x4 matrix:
  ...
  Scenario: Calculating the inverse of a third matrix
    Given the following 4x4 matrix X:
      |  9 |  3 |  0 |  9 |
      | -5 | -2 | -6 | -3 |
      | -4 |  9 |  6 |  4 |
      | -7 |  6 |  6 |  2 |
    Then inverse(X) is the following 4x4 matrix:
  ...
  Scenario: Multiplying a product by its inverse
    Given the following 4x4 matrix Y:
        |  3 | -9 |  7 |  3 |
        |  3 | -8 |  2 | -9 |
        | -4 |  4 |  4 |  1 |
        | -6 |  5 | -1 |  1 |
      And the following 4x4 matrix Z:
        |  8 |  2 |  2 |  2 |
        |  3 | -1 |  7 |  0 |
        |  7 |  0 |  5 |  4 |
        |  6 | -2 |  0 |  5 |
